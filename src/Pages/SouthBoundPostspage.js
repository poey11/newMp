...
const SouthBoundPosts = () => {
  ...
  return (
    <div className={styles.southBoundPosts}>
      ...
      <div className={styles.frame1}>
        ...
        <div className={styles.pageHeading}>
          <div className={styles.southBoundRoute}>South Bound Route Post</div>
      ...
      <div className={styles.frame2}>
        <div className={styles.frame3}>
          ...
          <div className={styles.southBoundTo}>South Bound to Place</div>
        </div>
      </div>
