...
import '../Page Style/NorthBoundpageCSS.css';

const NorthBoundPosts = () => {

  return (
    <div className="northBoundPosts">
      <div className="frame">
      ...
      <div className="frame1">
        ...
        <div className="pageHeading">
          <div className="northBoundRoute">North Bound Route Post</div>
      ...
      <div className="frame2">
        <div className="frame3">
          ...
          <div className="northBoundTo">North Bound to Place</div>
        </div>
      </div>
